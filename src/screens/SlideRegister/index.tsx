...
import { BottonInterface } from '../../components/ButtonInterface';
    ...
    return (
        <View style={styles.container}>
            <KeyboardAvoidingView>
                ...
                <BottonInterface title='Salvar' type='third' onPressI={handleRegister} />
                <BottonInterface title='Voltar' type='primary' onPressI={handleGoBack} />
            </KeyboardAvoidingView >
        </View >
    );
}